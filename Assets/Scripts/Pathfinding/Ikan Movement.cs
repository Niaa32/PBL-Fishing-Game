...
public class FishMovement : MonoBehaviour
{
    ...
    public float hookWaitDuration = 3f; // Durasi ikan menunggu di umpan sebelum dilepaskan
    ...
    private static bool isBaitOccupied = false; // Apakah umpan sedang dimakan ikan lain
    ...
    void DetectBait()
    {
        ...
        if (distanceToBait <= detectionRadius && !isBaitOccupied)
        {
            isMovingToBait = true;
            isBaitOccupied = true; // Tandai bahwa umpan sedang dimakan ikan
        }
    }
    ...
    void ResetFishAndBait()
    {
        ...
        isBaitOccupied = false; // Izinkan ikan lain mendekati umpan
    }
}
